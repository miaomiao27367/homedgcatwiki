...
var _AvatarDataConfig_ = {
    "133": {
        "BallList": [{"When": "Elemball (Other)", "CD": 2.5, "DropArray": [{"Num": 1.0, "Chance": 1.0}]}],
        "EndureList": [],
        "WindZoneList": [],
        "OtherDataList": []
    }
        ...
        "Ver": {
            "L": {
                ...
                "PassiveSkills": [
                    ...
                    {
                        "Name": "淑女的行事准则",
                        "Desc": "基于桑多涅的攻击力，提升其元素精通：每100点攻击力都将使桑多涅的元素精通提升8点，至多通过这种方式提升160点元素精通。",
                    ...
                    {
                        "Name": "茶会的序曲与长长的故事",
                        "Desc": "桑多涅处于队伍中时，向凯瑟琳交付每日委托任务后，会获得额外的茶点奖励。",
    ...
    "133": {
        "AttackList": [
            ...
            },
            {
                ...
                "AtkTag": "ExtraAttack",
                "AttTag": "",
                "AttGrp": "Avatar_Marionette_MachineGun",
                "Element": "Ice",
                "GU": 1,
                "Poise": 10.0,
                "ForceType": 0,
