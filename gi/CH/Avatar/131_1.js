...
var _AvatarDataConfig_ = {
    "131": {
        "BallList": [{"When": "OtherLogic (ElementalArt)", "CD": 0.5, "DropArray": [{"Num": 1.0, "Chance": 1.0}]}],
        "EndureList": [],
        "WindZoneList": [],
        "OtherDataList": []
    }
        ...
        "Ver": {
            "L": {
                ...
                "PassiveSkills": [
                    ...
                    {
                        "Name": "静念",
                        "Desc": "在提瓦特，不处于战斗状态下时，若已获得当前区域的寻宝罗盘，则尼可的重击将会转而施放「御使之引」：呼唤附近的仙灵指引道路，触发等同于当前区域寻宝罗盘的效果。<br>该效果有5秒的冷却时间，且在秘境、征讨领域、深境螺旋中无效。",
                ...
                "Constellations": [
                    {
                        "Level": 1,
                        "Name": "「不要惧怕，蒙眷爱的人之子呀」",
                        "Desc": "队伍中自己的当前场上角色攻击命中敌人时，将会额外召唤出特殊的「奥迹造影·合一」，对敌人进行协同攻击，依据该角色的元素类型，造成对应元素范围伤害，该伤害相当于该角色攻击力的600%，并视为由该角色造成的伤害。<br>该效果每6秒至多触发一次。",
...
var _AvatarAttackConfig_ = {
    "131": {
        "AttackList": [
            ...
            {
                "Skill": "AngelAttack_Klee_Bomb_SkillObj",
                "Shape": {
                    "Type": "Default",
                    "Size": [
                        0
