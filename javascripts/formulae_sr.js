$(function () {
    ...
    var data = [
        ...
        },
        {
            Title: '欢愉伤害',
            DescList: [
                '欢愉命途角色造成的特殊伤害：$$欢愉伤害=\\;\\begin{aligned}&技能倍率 \\times (1+欢愉度\\%) \\times (1+增笑\\%) \\\\ &\\times\\left(1+\\frac{5 \\times 笑点}{笑点+240}\\right) \\\\ &\\times (1+易伤\\%) \\times (1-减伤1\\%) \\times (1-减伤2\\%) \\times (1-减伤3\\%)\\times\\cdots \\\\ &\\times 暴击区 \\times 抗性系数 \\times 防御系数 \\\\ &\\times 真实伤害区 \\times 特殊独立乘区\\end{aligned}$$',
                '@欢愉度#：角色当前累积的欢愉度数值',
                '@增笑%#：增加笑点伤害的加成效果',
                '@特殊独立乘区#：如最终伤害加成等极为特殊的效果'
            ]
